...
public class DispatchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idDispatch = request.getParameter("id");
       
        DispatchServiceInterface dsi = new DispatchServiceDB();
        
        Dispatch dispatch = dsi.getOneDispatch(idDispatch);
        
        request.setAttribute("dispatch", dispatch);
        
        getServletContext().getRequestDispatcher("/Jsp/dispatch.jsp").forward(request, response);
